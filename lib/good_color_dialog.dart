...
class GoodColorDialog extends StatefulWidget {
  @override
  State<StatefulWidget> createState() => _GoodColorDialogState();
}

class _GoodColorDialogState extends State<GoodColorDialog> {
